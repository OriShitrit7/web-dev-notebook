const topics = [
  ...
  { section: 'JavaScript', num: '05', slug: 'js-conditionals', title: 'Conditionals', subtitle: 'if, else ותנאים', file: 'content/js/conditionals.md', ready: true },
  { section: 'JavaScript', num: '06', slug: 'js-loops', title: 'Loops', subtitle: 'לולאות ומעבר על נתונים', file: 'content/js/loops.md', ready: true },
  { section: 'JavaScript', num: '07', slug: 'js-functions', title: 'Functions', subtitle: 'פונקציות ו־arrow functions', file: 'content/js/functions.md', ready: true },
  { section: 'JavaScript', num: '08', slug: 'js-arrays', title: 'Arrays', subtitle: 'מערכים ומתודות מרכזיות', file: 'content/js/arrays.md', ready: true },
  { section: 'JavaScript', num: '09', slug: 'js-objects', title: 'Objects', subtitle: 'אובייקטים ו־JSON', file: 'content/js/objects.md', ready: true },
