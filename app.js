const topics = [
  ...
  { section: 'CSS', num: '05', slug: 'css-colors-backgrounds', title: 'Colors & Backgrounds', subtitle: 'צבעים, רקעים וגרדיאנטים', ready: false },
  { section: 'CSS', num: '06', slug: 'css-units-sizing', title: 'Units & Sizing', subtitle: 'px, em, rem, אחוזים וגדלים', ready: false },
  { section: 'CSS', num: '07', slug: 'css-typography', title: 'Typography', subtitle: 'גופנים ועיצוב טקסט', ready: false },
  { section: 'CSS', num: '08', slug: 'css-box-model', title: 'Box Model', subtitle: 'padding, border ו־margin סביב כל אלמנט', ready: false },
  { section: 'CSS', num: '09', slug: 'css-borders-shadows', title: 'Borders, Shadows & Outlines', subtitle: 'מסגרות, פינות, צללים וקווי מיקוד', ready: false },
  { section: 'CSS', num: '10', slug: 'css-display-positioning', title: 'Display & Positioning', subtitle: 'זרימת המסמך ומיקום אלמנטים', ready: false },
  { section: 'CSS', num: '11', slug: 'css-flexbox', title: 'Flexbox', subtitle: 'פריסה חד־ממדית', ready: false },
  { section: 'CSS', num: '12', slug: 'css-grid', title: 'Grid', subtitle: 'פריסה דו־ממדית', ready: false },
  { section: 'CSS', num: '13', slug: 'css-variables', title: 'CSS Variables', subtitle: 'משתנים מותאמים אישית', ready: false },
  { section: 'CSS', num: '14', slug: 'css-responsive', title: 'Responsive Design', subtitle: 'התאמה לכל גודל מסך', ready: false },
